...
export function getEthPriceInUSD(): BigDecimal {
  ...
  let daiPair = Pair.load(DAI_WNATIVE_PAIR) // dai is token0
  let usdcPair = Pair.load(USDC_WNATIVE_PAIR) // usdc is token0
  let usdtPair = Pair.load(USDT_WNATIVE_PAIR) // usdt is token1
